...
# 打开并显示文件
im = Image.open('E:\\liyuan-github\\my-algorithm\\python-vsc\\geekbangtrain\\week02\\2e\\p8_captcha\\cap.jpg')
im.show()
...
th = Image.open('E:\\liyuan-github\\my-algorithm\\python-vsc\\c_th.jpg')
