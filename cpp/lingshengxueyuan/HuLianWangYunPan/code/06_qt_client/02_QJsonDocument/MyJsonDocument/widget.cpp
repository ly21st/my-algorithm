...
void Widget::test1()
{
    QFile file("../../MyJsonDocument/test1.json");
    ...
    /*
        {
            "files":	[{
                    ...
                    "share_status":	1,
                    "pv":	1,
                    "create_time":	"2020-07-04 14:34:35",
                    "url":	"http://172.16.0.15:80/group1/M00/00/00/rBAAD18AISGAP6QrAAACRhizVvQ79062.h",
                    "size":	582,
                    "type":	"h"
                }, {
                    "user":	"milo",
                    "md5":	"4d41f1670e561265d08d8900a5b33550",
                    "file_name":	"object_script.0voiceCloudDisk.Debug",
                    "share_status":	1,
                    "pv":	1,
                    "create_time":	"2020-07-04 15:33:49",
                    "url":	"http://172.16.0.15:80/group1/M00/00/00/rBAAD18AMDmATF-XAAADCJyG1G02.Debug",
                    "size":	776,
                    "type":	"Debug"
                }]
        }
...
void Widget::test3()
{
    /*
        ...
        "files":
            [
                {
                "url": "http://192.168.52.139:80/group1/M00/00/00/wKg0i178TjmAOWgKAAAEWYnz98s6.mp4",
                "filename": "test.mp4",
                "user": "milo"
                },

                {
                "url": "http://192.168.52.139:80/group1/M00/00/00/wKg0i178QTCASB-BAAAk_Jaka_w98999.h",
                "filename": "login.h",
                "user": "milo"
                }
            ]
    ...
    */
    ...
    QVariantMap tmp1;
    tmp1.insert("url", "http://192.168.52.139:80/group1/M00/00/00/wKg0i178TjmAOWgKAAAEWYnz98s6.mp4");
    tmp1.insert("filename", "test.mp4");
    tmp1.insert("user", "milo");

    QVariantMap tmp2;
    tmp2.insert("url", "http://192.168.52.139:80/group1/M00/00/00/wKg0i178QTCASB-BAAAk_Jaka_w98999.h");
    tmp2.insert("filename", "login.h");
    tmp2.insert("user", "milo");
...
void Widget::test5()
{
    ...
    map4_1.insert("姓名", "yaoming");
    map4_1.insert("性别", "男");
    map4_1.insert("年龄", "35");

    map4_2.insert("姓名", "luyu");
    map4_2.insert("性别", "女");
    map4_2.insert("年龄", "40");
